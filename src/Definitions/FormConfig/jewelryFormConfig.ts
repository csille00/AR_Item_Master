...
import {age, ArJewelryMasterColumns, gender, LabeledInputType, ProductTypeIds, Status} from "../enum.ts";
    ...
    getAllColumns = async (): Promise<FormColumn[]> => {
        ...
        try {
            return [
                ...
                new FormColumn(ArJewelryMasterColumns.STATUS, LabeledInputType.SELECT, false, this.statusOption),
            ];
        } catch (error) {
