        ...
        <div className="flex flex-col items-center bg-argray h-full shadow-md p-2">
            ...
            <div className="">
                <NavLink
                    to={"/"}
                    className={({isActive}) =>
                        `text-xl mb-6 flex items-center hover:font-bold text-left
                        ${isActive
                ...
                >
                    ...
                    <>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                             stroke={isActive ? "#A6947A" : "#BABCBE"} className="size-6 mr-4">
                ...
                <NavLink
                    to={"/admin"}
                    className={({isActive}) =>
                        `text-xl flex items-center hover:font-bold text-left
                        ${isActive
                            ? 'text-argold font-bold hover:text-argold'
                            : 'font-light text-lightgr hover:text-lightgr'
                        }`
